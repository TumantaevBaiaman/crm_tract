    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hst', models.CharField(max_length=255)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='account')),
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.modelssatusaccount')),
            ],
        ),
    ]
